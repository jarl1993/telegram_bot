...
def help_command(update: Update, context: CallbackContext) -> None:
    help_text = (
        ...
        "/OEP - Información sobre las Ofertas de Empleo Públicos publicadas. Actualmente solo disponemos de la oferta del año 2024.\n"
...
# Comando para enviar información sobre la OEP
def oep_command(update: Update, context: CallbackContext) -> None:
    oep_texto = (
        "OEP 2024: El 9 de septiembre de 2024 se han publicado 15 plazas de administrativo tal y como se recoge en el BOJA: "
        "https://www.juntadeandalucia.es/boja/2024/175/12"
    )
    update.message.reply_text(oep_texto)
...
def main() -> None:
    ...
    dispatcher.add_handler(CommandHandler("OEP", oep_command))  # Comando para información sobre la OEP
